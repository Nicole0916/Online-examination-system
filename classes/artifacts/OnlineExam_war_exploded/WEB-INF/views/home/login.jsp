...
<head>
	...
	<link href="${pageContext.request.contextPath}/resources/admin/easyui/assets/libs/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
	<style>
		.bg-primary{
			background:url('${pageContext.request.contextPath}/resources/home/images/bgf.jpg');
		...
		<main>
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-5" style="margin-top: 50px;opacity: 0.85">
						<div class="card shadow-lg border-0 rounded-lg mt-5">
							<div class="card-header"><h3 class="text-center font-weight-light my-4"><img src="${pageContext.request.contextPath}/resources/home/images/logo_min.png" width="70xp">基于教考分离的考试系统</h3></div>
							<div class="card-body">
								<form>
