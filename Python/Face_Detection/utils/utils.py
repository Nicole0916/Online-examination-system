...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    if isinstance(path, str):  # *.yaml file
        ...
        from yolov5_ultralytics import LoadImagesAndLabels
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        c2 = c1[0] + 15 * line_thickness * len(label), c1[1] - 15 * line_thickness
        ...
        fontStyle = ImageFont.truetype(
            "font/simsun.ttc", 15*line_thickness,encoding="utf-8")
        draw.text((c1[0], c1[1]-15*line_thickness), label, (0,0,0), font=fontStyle)
        img = pil_im
        return img
