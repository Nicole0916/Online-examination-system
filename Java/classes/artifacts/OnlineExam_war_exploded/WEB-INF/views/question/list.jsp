        ...
        <table>
            ...
            <tr>
	            ...
	            <tr>
	                ...
	                <td><input type="text" id="add-attrA" name="attrA" class="wu-text" ></td>
	            </tr>
	            <tr>
	                <td align="right">试题选项B:</td>
	                <td><input type="text" id="add-attrB" name="attrB" class="wu-text" ></td>
	            </tr>
	            <tr>
	            ...
	            <tr>
	                ...
	                <td><input type="text" id="add-answer" name="answer" class="wu-text" ></td>
	            </tr>
