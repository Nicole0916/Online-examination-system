...
public class Exam {
	...
	private int fillQuestionNum;//填空题数量
	private int shortQuestionNum;//简答题数量
	private int paperNum;//试卷数量
	public int getFillQuestionNum() {
		return fillQuestionNum;
	}
	public void setFillQuestionNum(int fillQuestionNum) {
		this.fillQuestionNum = fillQuestionNum;
	}
	public int getShortQuestionNum() {
		return shortQuestionNum;
	}
	public void setShortQuestionNum(int shortQuestionNum) {
		this.shortQuestionNum = shortQuestionNum;
	}
